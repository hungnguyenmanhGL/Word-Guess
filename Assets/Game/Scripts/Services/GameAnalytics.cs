...
public static class GameAnalytics {
    ...
    public struct GameRevenue {
        ...
        public GameRevenue(string adPlatform, string adSource, string adUnit, string adFormat, double value, string currencyCode) {
    ...
    public static void LogRevenue(GameRevenue gameRevenue) {

        AnalyticRevenue analyticRevenue = new AnalyticRevenue(gameRevenue.AdPlatform, gameRevenue.AdSource, gameRevenue.AdUnit, gameRevenue.AdFormat, gameRevenue.Value, gameRevenue.CurrencyCode);

        AnalyticManager.LogRevenue(analyticRevenue);
